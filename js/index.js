...
function resetTabSelected() {
    ...
    // iterate known header/gtab ids and guard against missing elements
    for (var i = 1; i <= 6; i++) { 
        let gtabs = document.getElementById('gtabs' + i);
        let headers = document.getElementById('header' + i);
        if (gtabs && gtabs.classList) { gtabs.classList.remove('selected'); }
...
function resetHeaderSelected() {
    ...
    for (var i = 1; i <= 6; i++) { 
        let headers = document.getElementById('header' + i);
        if (headers && headers.classList) { headers.classList.remove('selected'); }
    };
